...
exp_str=share_double_head_transformer_ShareV_out_proj_FFN_E6D6_from_sirius
#===========================
...
main.py -m sgdt_dn_dab_detr \
  ...
  --resume logs/$out_dir/share_double_head_transformer_ShareV_out_proj_FFN_E6D6_b2x8/sirius_checkpoint0039.pth \
  --save_checkpoint_interval 5 \
  --wandb
  
    # smlp_k0.sh  smlp_k0_b2x2_from_sirius.sh  smlp_k0_b2x2_from_this.sh  smlp_k0_b2x4.sh
  
  ./smlp_k0_b2x2_from_sirius.sh
...
main.py -m dn_dab_detr --output_dir logs/$out_dir/$exp_str \
  ...
  --pretrain_model_path logs/e6-d6-gt_split_only/share_double_head_transformer_ShareV_out_proj_FFN/checkpoint_transfer_weight.pth \
  
  
  --wandb \
     
  --no_resume_optimizer_lr_schedule \
   sftp://133.21.219.102/home/kaikai/project/DN-DETR/bash_back_20221212/gpu2.sh

...
class AnnotateTracklet(AnnotateBBox, Visualization, IoUTracker):
    ...
    def keyboard_listener(self, pressed_key, tmp_img=None):
        ...
        elif pressed_key == self.keyboard['-']:
    ...
    def tracking_main(self):
        ...
        if len(txt_list) == 0:
            ...
            if num_bbox > 0:
                ...
                self.clusters = self.sorted_clusters_based_on_image_id(clusters)
    ...
    def Event_ShowActiveObjectTrackbar(self):
        ...
        if self.show_only_active_cluster_on and len(self.clusters) > 1 and checkTrackBarPos == -1:

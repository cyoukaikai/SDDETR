...
#     'non_empty_detection_file'
    ...
    #     test_image_list = smrc.not_used.get_file_list_recursively(
    ...
    #         smrc.not_used.generate_dir_if_not_exist(result_dir)
    #         print(f'Saving object_detection result to {result_dir} ... ')
...
#         smrc.not_used.save_bbox_to_file(truth_file_path, truth)
...
#     ann_path_list = smrc.not_used.get_file_list_in_directory(label_dir)
#     prediction_all = []
...
#     #     deprecated = file_idx_list[pred_idx-1]
#     #     print(f'{pred_idx}th prediction, ann_path = {ann_path_list[deprecated]}')
#     sys.exit(0)
#     return prediction_all

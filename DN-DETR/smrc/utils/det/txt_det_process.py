...
def extract_raw_detection_to_bbox_list(image_dir, label_dir, score_position, score_thd=None, nms_thd=None):
    ...
    # ===================================================
    # typical use: face extraction from the object_detection result of tiny face network
    # =================================================
    ...
    for idx, dir_name in enumerate(dir_list):
        ...
        for ann_path in ann_path_list:
            ...
            # the object_detection may include invalid result (e.g., x1, x2 < 0, or > image_width)
            # so we need to check

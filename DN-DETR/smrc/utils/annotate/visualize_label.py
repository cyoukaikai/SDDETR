...
from smrc.utils.file_path import non_blank_lines, get_dir_list_in_directory
...
class VisualizeLabel(AnnotationTool):
    def __init__(self, image_dir, label_dir,
        ...
        super().__init__(
           image_dir, label_dir, class_list_file
        )
    ...
    def main_loop(self):
        ...
        while True:
            ...
            if self.active_directory is not None:
                print('Start visualize the annotation or object_detection result for '

...
class GameController(Music):
    ...
    #             #1: 'hat1'
    #         }
    #         # use test_button_axis_hat() function to assist the defination of the names of the buttons,
    #         # axis, and hat.
    #
    ...
    # #     self.music_playlist = smrc.not_used.get_file_list_recursively(root_dir, ext_str='.mp3')

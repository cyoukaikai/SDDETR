...
import smrc.utils
from models.sgdt.scoring_gt import unnormalize_box, resize_sgdt_target, INTERPOLATE_MODE
from models.sgdt.scoring_eval import get_pred_fg_tokens_classified, get_pred_split_tokens_classified
...
class VisualizeToken:
    ...
    def save_significant_score_and_split_tokens(self, sub_dir=None):
        ...
        significance_score = self.sgdt_output['small_scale_score']  # N, B
    ...
    def visualize_split_prediction(
        ...
        if torch.is_tensor(feat_map_size):
            feat_map_size = self.sgdt_output['feat_map_size'].detach().cpu().numpy()

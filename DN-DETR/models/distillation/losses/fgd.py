...
class FeatureLoss(nn.Module):
    ...
    def __init__(self,
        ...
        # if student_channels != teacher_channels:
        # always conduct feature transfer to map the student and teacher features to the same embedding space
        # self.align = nn.Conv2d(student_channels, teacher_channels, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self,
        ...
        for i in range(N):
            ...
            # 'img_shape' = {tuple: 3} (900, 1600, 3)  --> always keep the current size of the img
            # not the ['pad_shape']

...
eval_model() {
	...
	main.py -m sgdt_dn_dab_detr \
	  ...
	  --eval \
	  --eval_decoder_layer  $eval_decoder_layer_ \
	  --pretrain_model_path  $weight_dir_/checkpoint.pth | tee $result_dir_/"$log_date_"batchsize-$batch_size_-eval_decoder_layer$eval_decoder_layer_"-"$token_scoring_discard_split_criterion_-$token_scoring_gt_criterion_
}
...
out_dir=R50_lr0.5_x2gpus

exp_str=R50_lr0.5_x2gpus
weight_dir=logs/$out_dir
 
batch_size=2

eval_model $pad_fg_pixel $token_scoring_loss_criterion $token_scoring_gt_criterion $token_scoring_discard_split_criterion $weight_dir $batch_size $exp_str -1

eval_model $pad_fg_pixel $token_scoring_loss_criterion $token_scoring_gt_criterion $token_scoring_discard_split_criterion $weight_dir $batch_size $exp_str 4

eval_model $pad_fg_pixel $token_scoring_loss_criterion $token_scoring_gt_criterion $token_scoring_discard_split_criterion $weight_dir $batch_size $exp_str 0
eval_model $pad_fg_pixel $token_scoring_loss_criterion $token_scoring_gt_criterion $token_scoring_discard_split_criterion $weight_dir $batch_size $exp_str 1

eval_model $pad_fg_pixel $token_scoring_loss_criterion $token_scoring_gt_criterion $token_scoring_discard_split_criterion $weight_dir $batch_size $exp_str 2
eval_model $pad_fg_pixel $token_scoring_loss_criterion $token_scoring_gt_criterion $token_scoring_discard_split_criterion $weight_dir $batch_size $exp_str 3
...
batch_size=4
eval_model $pad_fg_pixel $token_scoring_loss_criterion $token_scoring_gt_criterion $token_scoring_discard_split_criterion $weight_dir 	$batch_size $exp_str

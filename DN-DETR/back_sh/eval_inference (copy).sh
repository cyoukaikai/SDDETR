...
export CUDA_VISIBLE_DEVICES=1,2  # 1,2
...
eval_model() {
	...
	main.py -m sgdt_dn_dab_detr \
	  ...
	  --eval \
	  --pretrain_model_path  $weight_dir_/checkpoint.pth | tee results_/test_record_results-$log_date_-batchsize-$batch_size_-$token_scoring_discard_split_criterion_-$token_scoring_gt_criterion_
}
...
weight_dir=logs/debug/copied_benchmark/finetune-split-only-pad0-bilinear-pad32/R50 
...
# token_scoring_discard_split_criterion=gt_only_exp-no_bg_token_remove-reclaim_padded_region-debug_gt_split_ratio0.0
token_scoring_discard_split_criterion=gt_only_exp-no_bg_token_remove-reclaim_padded_region
out_dir=benchmark-version/gt-split-exp/gt_only_exp-reclaim_padded_region-no_bg_token_remove-16-gt_fg_scale_fake-fg_scale_class_all_fg

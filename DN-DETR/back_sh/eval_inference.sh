...
eval_model() {
  ...
  --gt_decay_criterion start_epoch8-end_epoch11 \
	  --eval \
	  --pretrain_model_path  $weight_dir_/checkpoint0010.pth | tee $result_dir_/"$log_date_"batchsize-$batch_size_-$token_scoring_discard_split_criterion_-$token_scoring_gt_criterion_
}
...
weight_dir=logs/$out_dir/finetune-split-only_significant-value-from-pad0-bilinear-to-pad32
exp_str=finetune-split-significant-valuepad32-use_proposal-min_split_score0.3-nms_thd0.6

#token_scoring_discard_split_criterion=gt_only_exp-no_bg_token_remove-reclaim_padded_region-split_1c
#
#weight_dir=logs/regular_5-sgdt_1/split-1c-R50-regular_5-sgdt_1-gt_only_exp-no_bg_token_remove-reclaim_padded_region-pad0

# without_update_pos_encoding  without_update_src_mask no_update_src_key_mask
# sweap_1c_with_2c_channels
#exp_str=max_num_possible_split

...
export CUDA_VISIBLE_DEVICES=0,1  #1,2
...
view_split $pad_fg_pixel $token_scoring_loss_criterion $token_scoring_gt_criterion $token_scoring_discard_split_criterion $weight_dir 	$batch_size

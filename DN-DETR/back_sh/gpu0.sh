...
exp_str=debug-loss_coef0.1-ShareV-feat-offline-distill-from_ShareV_out_proj_FFN_attn52_2ap
#===========================
...
out_dir=e6-d6-gt_split_only
exp_str=sgdt_token_fg_bg_classifier_pretrained_detr44AP_5e-5
#===========================
...
token_scoring_gt_criterion=fg_scale_class_all_fg
out_dir=e6-d6-gt_split_only
exp_str=sgdt_token_fg_bg_classifier_sMLP_Fg_KV_lr_5e-5
#===========================
...
token_scoring_gt_criterion=fg_scale_class_all_fg
out_dir=e6-d6-gt_split_only
exp_str=sgdt_token_fg_bg_classifier_sMLP_Fg_KV_lr_5e-4
#===========================

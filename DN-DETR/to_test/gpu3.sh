...
encoder_layer_config=regular_5-DualAttnShareVFFN_1
exp_str=kaikai_gcp_batch2x2_sMLP_K_regular_5-DualAttnShareVFFN_1
#===========================

# -m torch.distributed.launch --nproc_per_node=$GPU_NUM --master_port=$master_port \

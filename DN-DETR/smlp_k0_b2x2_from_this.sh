...
exp_str=share_double_head_transformer_ShareV_out_proj_FFN_E6D6_from_this
#===========================
...
main.py -m sgdt_dn_dab_detr \
  ...
  --resume logs/$out_dir/share_double_head_transformer_ShareV_out_proj_FFN_E6D6_b2x8/checkpoint0039.pth \
  --save_checkpoint_interval 5 \
  --wandb
  
    # smlp_k0.sh  smlp_k0_b2x2_from_sirius.sh  smlp_k0_b2x2_from_this.sh  smlp_k0_b2x4.sh
  
  ./smlp_k0_b2x2_from_this.sh
